...
<html>
	<head>
		...
		<title>UFU 2017 Bacharelado - Questões Discursivas</title>
	</head>
	<body>
		...
		<div class="mx-auto mb-5 table-responsive" style="width: 100%">
			<table id="tabela" class="table table-bordered table-hover table-sm">
				<caption>UFU 2017 Bacharelado - Questões Discursivas</caption>
				...
				<tbody>
					<?php 
						...
						$sql = "SELECT N, AREA, M_UFU, DP_UFU, M_ESTADO, DP_ESTADO, M_REGIAO, DP_REGIAO, M_PUBLICAS, DP_PUBLICAS, M_UNIVERSIDADES, DP_UNIVERSIDADES, M_BRASIL, DP_BRASIL FROM bachareladoufu2017disc";
