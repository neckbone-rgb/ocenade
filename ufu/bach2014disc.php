...
<html>
	<head>
		...
		<title>UFU 2014 Bacharelado - Questões Discursivas</title>
	</head>
	<body>
			...
			<table class="table table-bordered table-hover table-sm">
				...
				<tbody>
					<?php 
						...
						$sql = "SELECT N, AREA, M_UFU, DP_UFU, M_ESTADO, DP_ESTADO, M_REGIAO, DP_REGIAO, M_PUBLICAS, DP_PUBLICAS, M_UNIVERSIDADES, DP_UNIVERSIDADES, M_BRASIL, DP_BRASIL FROM bachareladoufu2014disc";
