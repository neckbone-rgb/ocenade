...
<html>
	<head>
		...
		<title>UFU 2014 Bacharelado - Questões Objetivas</title>
	</head>
	<body>
		...
		<div class="mx-auto table-responsive" style="width: 100%">
			<table class="table table-bordered table-hover table-sm">
				...
				<thead class="thead-dark mt-5">
					<tr>
						<th rowspan="2" colspan="1" class="a">Questão</th>
						<th rowspan="2" colspan="1" class="a">Área</th>
				...
				<tbody">
					<?php 
						...
						$sql = "SELECT * FROM bachareladoufu2014obj";
